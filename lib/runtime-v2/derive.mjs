...
export function renderMaterializedConfig(derived) {
  ...
  const lines = [
    ...
    "version: 2",
    "",
    "# Optional shared reviewer executable for v1 and v2; unset keeps legacy Claude lookup.",
    "# argsPrefix is literal argv; use an absolute path for a Node entry script.",
    "# reviewerRuntime:",
