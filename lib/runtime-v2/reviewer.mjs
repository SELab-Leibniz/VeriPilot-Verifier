      ...
      items: {
        ...
        properties: {
          ...
          verification: {
            type: ["object", "null"],
            additionalProperties: false,
            required: ["platform", "runtimeRequired", "modalities", "evidenceKinds"],
            properties: {
              platform: { type: ["string", "null"] },
              runtimeRequired: { type: "boolean" },
              realDeviceOnly: { type: "boolean" },
              modalities: {
                type: "array",
                uniqueItems: true,
                items: { type: "string", enum: ["build", "device", "ui"] },
              },
              evidenceKinds: {
                type: "array",
                uniqueItems: true,
                items: {
                  type: "string",
                  enum: ["build", "install", "launch", "ui-action", "ui-assertion", "screenshot", "ui-dump", "restart"],
                },
              },
            },
          },
