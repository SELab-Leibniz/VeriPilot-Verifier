...
export async function loadStageCatalog({
  ...
  return parseStageCatalog(contents, catalogPath);
}


function parseStageCatalog(contents, catalogPath) {
...
const DEFAULT_CATALOG_PATH = path.join(MODULE_ROOT, "config", "runtime.yaml");
export const DEFAULT_STAGE_CATALOG = parseStageCatalog(
  readFileSync(DEFAULT_CATALOG_PATH, "utf8"), DEFAULT_CATALOG_PATH,
);
