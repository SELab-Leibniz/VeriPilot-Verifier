...
import { isInternalExecution, isManagedExecution, runManagedExecution, runBackgroundExecution } from "./internal-context.mjs";
      ...
      controller.promise = (async () => {
        ...
        const result = await withController({ projectRoot: params.workspaceDir, sessionId: params.sessionId,
          ...
          try {
            ...
            let prompt = continuation ? `[runtime-corrector:feedback]\n${continuation.intent.feedback}` : params.prompt, finalResult, assessment = 0;
