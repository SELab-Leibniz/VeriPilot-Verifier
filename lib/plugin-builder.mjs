...
export async function buildPlugin({ host, sourceRoot, outputRoot }) {
  ...
  if (host === "openclaw") {
    ...
    packageDocument.version = "1.9.1-openclaw.1";
  ...
  if (host === "openclaw") {
    ...
    await fs.writeFile(path.join(artifactRoot, "README.md"), guide.replace("(openclaw-acceptance.md)", "(docs/openclaw-acceptance.md)"));
